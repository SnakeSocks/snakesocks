...
binary_safe_string client_encode(connect_info *, binary_safe_string data)
{
    if (somecond)
    {
...
binary_safe_string client_decode(connect_info *, binary_safe_string data)
{
    if (somecond)
    {
        return do_something_by_cxx(data);
...
binary_safe_string server_encode(connect_info *, binary_safe_string data)
{
    if(somecond)
    {
...
binary_safe_string server_decode(connect_info *, binary_safe_string data)
{
    if(somecond)
    {
        return do_something(data);
